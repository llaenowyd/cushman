...
function tr(e, n) {
  var t = n || {},
    a = t.padLeft === !1 ? se : pn,
    r = t.padRight ? pn : se
  return e[e.length - 1] === se && (e = e.concat(se)), e.join(r + Ee + a).trim()
}
var ar = za,
  dn = He,
  rr = Ya,
            ...
            for (var x in s)
              if (s.hasOwnProperty(x)) {
                ...
                k === 'Object' && !p[y(h)]
                  ...
                  : k === 'Array' && !p[y(h)] && ((p[y(h)] = !0), o(h, c, x, p))
              }
          },
        },
        plugins: {},
            ...
            a.addEventListener(
              ...
              function (o) {
                var s = JSON.parse(o.data),
                  ...
                  u = s.code,
                  p = s.immediateClose
                a.postMessage(l.highlight(u, l.languages[c], c)), p && a.close()
              },
              !1
            )),
        l
...
//# sourceMappingURL=syntaxhighlighter.4433922b.js.map
